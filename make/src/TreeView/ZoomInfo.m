...
- (BOOL) checkForModifierFlags:(NSEventModifierFlags)flags;
@end

@implementation ZoomInfo
@synthesize image = _image;
@synthesize imageRect = _rect;
...
- (void) drawImage
{
	...
	[NSGraphicsContext currentContext].imageInterpolation = NSImageInterpolationLow;
	...
	[NSGraphicsContext currentContext].imageInterpolation = currentInterpolation;
}
