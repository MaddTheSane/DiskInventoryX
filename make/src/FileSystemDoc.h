...
- (BOOL) itemIsNode: (FSItem*) item; //helper methods; returns YES/NO for packages depending on the showPackageContents-Flag
...
extern NSString *FSItemsChanged; //some items are modified, deleted or added; userInfo is nil
