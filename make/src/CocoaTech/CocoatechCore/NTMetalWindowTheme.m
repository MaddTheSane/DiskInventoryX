...
@property (nonatomic, strong) NTGradientDraw *gradient;
@property (nonatomic, strong) NTGradientDraw *dimmedGradient;
@property (nonatomic, strong) NSColor *backgroundColor;
@property (nonatomic, strong) NSColor *dimmedBackgroundColor;
@property (nonatomic, strong) NSImage *normalImage;
@property (nonatomic, strong) NSImage *dimmedImage;
@end
