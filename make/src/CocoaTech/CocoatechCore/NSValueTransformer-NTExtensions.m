    ...
    if (number != nil) 
	{
		if ([number isKindOfClass:[NSNumber class]])
		{
			...
			if (bytes == 0)
				...
				result = [NSByteCountFormatter stringFromByteCount:bytes countStyle:NSByteCountFormatterCountStyleFile];
		}
	}
