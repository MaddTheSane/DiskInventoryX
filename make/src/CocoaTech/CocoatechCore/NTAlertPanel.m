 ...
 defaultsKey:(NSString*)defaultsKey;
{
	...
	if ([defaultsKey length])
	{
		...
		NSButton* checkbox = [[NSButton alloc] initWithFrame:NSMakeRect(10,5,300,20)];
...
enableEscOnOther:(BOOL)enableEscOnOther;
{
	...
	if (window)
		[[self alert] beginSheetModalForWindow:window modalDelegate:self didEndSelector:@selector(alertDidEnd:returnCode:contextInfo:) contextInfo:(__bridge void * _Nullable)([self contextInfo])];
    else
    {
