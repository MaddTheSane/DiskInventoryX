...
@property (nonatomic, strong) NSString *byteUnit;
@property (nonatomic, strong) NSString *kiloUnit;
@property (nonatomic, strong) NSString *megaUnit;
@property (nonatomic, strong) NSString *gigaUnit;
...
{
    NSString* result = [[self numFormatter] stringForObjectValue:@(number)];
...
{
	return [NSString stringWithFormat:@"%@ x %@", [[self numFormatter] stringForObjectValue:@(size.width)], [[self numFormatter] stringForObjectValue:@(size.height)]];
}
