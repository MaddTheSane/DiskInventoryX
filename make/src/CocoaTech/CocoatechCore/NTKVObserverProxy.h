...
{
	id<NTKVObserverProxyDelegateProtocol> __unsafe_unretained delegate;
}

@property (unsafe_unretained) id<NTKVObserverProxyDelegateProtocol> delegate;  // owner must clear before release
