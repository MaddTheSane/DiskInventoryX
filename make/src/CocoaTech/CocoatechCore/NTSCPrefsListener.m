...
- (void)setupAllPrefsNotification;
{
	...
	prefcontext.info = (__bridge void * _Nullable)(self);
...
static void allPreferencesCallBack(SCPreferencesRef prefs,
								   ...
								   void *info)
{
	NTSCPrefsListener* listener = (__bridge NTSCPrefsListener*)info;
...
{
	NTSCPrefsListener* listener = (__bridge NTSCPrefsListener*)context;
