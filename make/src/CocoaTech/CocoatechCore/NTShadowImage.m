...
@property (nonatomic, strong) NSImage *topShadowImage;
@property (nonatomic, strong) NSImage *leftShadowImage;
@property (nonatomic, strong) NSImage *rightShadowImage;

@property (nonatomic, assign) CGFloat shadowOffset;
@property (nonatomic, assign) CGFloat shadowBlur;
@property (nonatomic, assign) NSUInteger shadowSize;
@property (nonatomic, strong) NSColor *topShadowColor;
