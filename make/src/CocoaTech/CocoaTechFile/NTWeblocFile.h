...
@property (readonly, getter=isHTTPWeblocFile) BOOL HTTPWeblocFile;
/// anything but http for now
@property (readonly, getter=isServerWeblocFile) BOOL serverWeblocFile;
...
@property (readonly, getter=isTextWeblocFile) BOOL textWeblocFile;
