...
// files only
@property (readonly) UInt64 dataLogicalSize;
@property (readonly) UInt64 dataPhysicalSize;
@property (readonly) UInt64 rsrcLogicalSize;
@property (readonly) UInt64 rsrcPhysicalSize;
