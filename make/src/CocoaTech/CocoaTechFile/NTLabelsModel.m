...
{
	return [self colorForLabel:label];
}

- (NSColor*)colorForLabel:(int)label
{
	return [(NTLabelColor*)[[self dictionary] objectForKey:[self keyForLabel:label]] color];
}

- (NSString*)nameForLabel:(int)label
{
	return [(NTLabelColor*)[[self dictionary] objectForKey:[self keyForLabel:label]] name];
}
...
{
	return [self nameForLabel:label];
}
