...
+ (BOOL)setApplicationBinding:(__unused NTFileDesc*)application forFile:(__unused NTFileDesc*)desc;
{
    OSStatus err = -1;
...
+ (BOOL)setApplicationBinding:(__unused NTFileDesc*)application forFilesLike:(__unused NTFileDesc*)desc;
{
    OSStatus err = -1;
