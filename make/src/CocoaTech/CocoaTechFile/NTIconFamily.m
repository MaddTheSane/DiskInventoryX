...
extern size_t CGPaletteGetIndexForColor(CGDirectPaletteRef palette, CGDeviceColor color) NS_DEPRECATED_MAC(10_0, 10_6);
extern CGDirectPaletteRef CGPaletteCreateDefaultColorPalette(void) NS_DEPRECATED_MAC(10_0, 10_6);
...
+ (Handle)get32BitDataFromBitmapImageRep:(NSBitmapImageRep*)bitmapImageRep requiredPixelSize:(int)requiredPixelSize
{
    ...
    {
        NSLog(@"get32BitDataFromBitmapImageRep:requiredPixelSize: returning NULL due to samplesPerPixel == %ld, bitsPerPixel == %ld", (long)samplesPerPixel, (long)bitsPerPixel);
        return NULL;
    }
...
+ (Handle)get8BitDataFromBitmapImageRep:(NSBitmapImageRep*)bitmapImageRep requiredPixelSize:(int)requiredPixelSize
{
    ...
    if (bitsPerSample != 8)
    {
        NSLog(@"get8BitDataFromBitmapImageRep:requiredPixelSize: returning NULL due to bitsPerSample == %ld", (long)bitsPerSample);
        return NULL;
    }
    ...
    {
        NSLog(@"get8BitDataFromBitmapImageRep:requiredPixelSize: returning NULL due to samplesPerPixel == %ld, bitsPerPixel == %ld", (long)samplesPerPixel, (long)bitsPerPixel);
        return NULL;
    }
...
+ (Handle)get8BitMaskFromBitmapImageRep:(NSBitmapImageRep*)bitmapImageRep requiredPixelSize:(int)requiredPixelSize
{
    ...
    if (bitsPerSample != 8)
    {
        NSLog(@"get8BitMaskFromBitmapImageRep:requiredPixelSize: returning NULL due to bitsPerSample == %ld", (long)bitsPerSample);
        return NULL;
    }
    ...
    {
        NSLog(@"get8BitMaskFromBitmapImageRep:requiredPixelSize: returning NULL due to samplesPerPixel == %ld, bitsPerPixel == %ld", (long)samplesPerPixel, (long)bitsPerPixel);
        return NULL;
    }
...
+ (Handle)get1BitMaskFromBitmapImageRep:(NSBitmapImageRep*)bitmapImageRep requiredPixelSize:(int)requiredPixelSize
{
    ...
    {
        NSLog(@"get1BitMaskFromBitmapImageRep:requiredPixelSize: returning NULL due to bitsPerPixel == %ld, samplesPerPixel== %ld, bitsPerSample == %ld", (long)bitsPerPixel, (long)samplesPerPixel, (long)bitsPerSample);
        return NULL;
    }
